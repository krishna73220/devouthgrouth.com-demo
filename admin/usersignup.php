                                    ...
                                    <div class="card mb-0 border-0">
                                        <div class="card-body p-sm-5 m-lg-4">
                                            <div class="text-center mt-2">
                                                ...
                                                <p class="text-muted">Get your free Devout Growth account now</p>
                                            </div>
                                            <div class="p-2 mt-5">
                                                <form class="needs-validation" novalidate action="index.php">
                                                    ...
                                                    <div class="mb-4">
                                                        <p class="mb-0 fs-sm text-muted fst-italic">By registering you agree to the DG <a href="pages-term-conditions.html" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                                    </div>
                                            ...
                                            <div class="mt-4 text-center">
                                                ...
                                                <a href="auth-signin.html" class="text-secondary text-decoration-underline"> Sign In </a>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
                                </div>
                                        ...
                                        <div class="card-body py-5 d-flex justify-content-between flex-column h-100">
                                            ...
                                            <div class="text-center">
                                                <p class="text-white opacity-75 mb-0 mt-3">
                                                    &copy;
                                                    <script>document.write(new Date().getFullYear())</script> DG. Crafted with <i class="ti ti-heart-filled text-danger"></i> by Devout Growth
                                                </p>
                                            </div>
                                        </div>
                                    </div>
